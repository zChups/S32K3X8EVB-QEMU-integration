...
#define bfd_mach_rx_v3         0x77
  ...
  //bfd_arch_s32k3x8evb,
//#define bfd_mach_s32k3x8evb 50
/*These lines declare the architecture and its machine type, enabling QEMU to recognize and handle disassembly for the new s32k3x8evb architecture.*/
  };
